...
```bash
npm install --save commit-from-action@^1.4.1
```
...
```bash
yarn add commit-from-action@^1.4.1
```
...
```bash
npm install --save @jaid/commit-from-action@^1.4.1
```
